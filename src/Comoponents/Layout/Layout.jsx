 ...
 function Layout(props: Props) {
  ...
  return (
    ...
    <Box sx={{ display: 'flex' }}>
      ...
      <Box className="d-flex align-items-center container gap-4">
      {Productdata.map((Product)=>{
          return(
              <Card className='p-2 shadow'>
              <Box className="text-center">  
      <img className='d-flex align-item-center rounded-2' style={{minHeight:"200px",maxHeight:"140px",maxWidth:"100px", minWidth:"180px"}} src={Product.img} alt="" />
      <Typography variant='h5'>{Product.Catogury}</Typography>
